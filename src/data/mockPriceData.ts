...
export const mockPriceEntries: PriceEntry[] = [
  ...
  },
  {
    ...
    price: 58,
    unitOfMeasurement: "kg",
    reporterId: "RYTHU_ANK",
    reporterName: "K. Venkatesh",
    department: "RYTHU",
    status: "flagged",
    submittedBefore2PM: true,
    priceDeviation: 16,
    thresholdBreached: false,
    remarks: "Price stable, minor increase observed"
  },
  {
    id: "PE002",
    date: "2024-12-08",
  ...
  },
  {
    ...
    price: 52,
    unitOfMeasurement: "kg",
    reporterId: "RYTHU_ATP",
    reporterName: "S. Ramesh",
    department: "RYTHU",
    status: "flagged",
    submittedBefore2PM: true,
    priceDeviation: 18,
    thresholdBreached: false,
    remarks: "Higher price reported at wholesale market"
  },
  {
    id: "PE003",
    date: "2024-12-08",
